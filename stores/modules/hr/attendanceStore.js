...
export const useAttendanceStore = defineStore("attendanceStore", {
  ...
  actions: {
    ...
    async GetPrintAttendanceSheet(req, showLoading) {
      console.log('API-GetPrintAttendanceSheetType2');
      console.log(JSON.stringify(req));
      ...
      try {
        const response = await axios.get(
          ...
          }/hr/Attendance/GetPrintAttendanceSheetType2?empNo=${req.empNo}&dateFrom=${
            req.dateFrom
          }&dateTo=${req.dateTo}`,
          {
            responseType: "blob", 
    ...
    async getProcessAttendenceLogs(req, showLoading) {
      ...
      try {
        const response = await axios.post(
          `${import.meta.env.VITE_API_URL}/hr/Attendance/GetProcessAttendenceLogs`,
          req
        );
        console.log("response:", response);
        if (response.data.isSuccess) {
