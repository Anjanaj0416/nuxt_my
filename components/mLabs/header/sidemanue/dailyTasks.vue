<template>
    <section>
        <div>
            ...
            <div @click="toggleSubmenu('Daily Tasks')"
                ...
                <svg :class="{ 'rotate-90': isSubmenuOpen['Daily Tasks'] }" class="w-4 h-4 transition-transform duration-200"
            ...
            <!-- Level 2 submenu -->
            <div v-show="isSubmenuOpen['Daily Tasks']" class="pl-4 mt-1 space-y-1">
                <router-link to="/mLabs/dailyTasks/appoinments"
