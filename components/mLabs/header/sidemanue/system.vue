<template>
    <section>
        <div>
            ...
            <div @click="toggleSubmenu('System')"
                ...
                <svg :class="{ 'rotate-90': isSubmenuOpen['System'] }" class="w-4 h-4 transition-transform duration-200"
            ...
            <!-- Level 2 submenu -->
            <div v-show="isSubmenuOpen['System']" class="pl-4 mt-1 space-y-1">
                <router-link to=""
                    class="block px-3 py-2 text-white rounded hover:bg-white hover:text-gray-600"
                    @click="$emit('close-sidebar')">
                    <span>System Backup <span class="text-red-500"> (recommended to backup once a week)</span></span>
                </router-link>
