<template>
    <section>
        <div>
            ...
            <div @click="toggleSubmenu('View/Edit')"
                ...
                <svg :class="{ 'rotate-90': isSubmenuOpen['View/Edit'] }" class="w-4 h-4 transition-transform duration-200"
            ...
            <!-- Level 2 submenu -->
            <div v-show="isSubmenuOpen['View/Edit']" class="pl-4 mt-1 space-y-1">
                <router-link to=""
