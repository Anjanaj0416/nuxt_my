        ...
        >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-2">
                ...
                <div>
                    ...
                    <div>
                    <p class="text-xs font-semibold text-gray-500 uppercase"></p>
                    <button 
                        type="button" 
                        class="text-white bg-brand mt-3 hover:bg-brand-strong rounded-lg box-border bg-red-500 border border-transparent text-xs px-3 py-1.5 focus:outline-none"
                    >
                    Remove
                    </button>
                </div>
