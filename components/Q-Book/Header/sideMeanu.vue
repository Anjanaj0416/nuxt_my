<template>
  <div>
    ...
    <aside :class="[
      'fixed inset-y-0 left-0 z-40 w-64  bg-[#bbd151] rounded-r-lg text-white overflow-y-auto shadow-lg transform transition-transform duration-300 ease-in-out',
      isOpen ? 'translate-x-0' : '-translate-x-full',
    ]" role="navigation" :aria-hidden="!isOpen">
      <!-- Top Navbar -->
      <div class="flex items-center justify-between px-6 py-4 bg-[#bbd151] shadow-md">
        <!-- Logo -->
