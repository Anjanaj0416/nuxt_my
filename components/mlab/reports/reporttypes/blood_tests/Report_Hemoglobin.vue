  ...
  <article>
    ...
    <div class="bg-EF-green-300 p-4 my-1 rounded-lg">
      <div class="grid grid-cols-1 gap-x-2">
        <parameter_text_row :reportparameter="report_details.hemoglobin" />
      </div>
    </div>
...
export default {
  ...
  methods: {
    getclearValues() {
      if (this.report_details.hemoglobin) this.report_details.hemoglobin.value = 0.0
...
<style scoped>
/* Optional styling for the article */
</style>
