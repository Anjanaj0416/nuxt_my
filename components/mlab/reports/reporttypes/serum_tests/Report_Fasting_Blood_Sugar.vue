  ...
  <article>
    ...
    <div class="bg-EF-green-300 p-4 my-1 rounded-lg">
      <div class="grid grid-cols-1 gap-x-2">
        <parameter_text_row :reportparameter="report_details.fasting_blood_glucose" />
        <parameter_text_row :reportparameter="report_details.urine_gluecose" />
      </div>
    </div>
...
export default {
  ...
  methods: {
    getclearValues() {
      if (this.report_details.fasting_blood_glucose)
        this.report_details.fasting_blood_glucose.value = 0.0
      if (this.report_details.urine_gluecose)
        this.report_details.urine_gluecose.value = 0.0
