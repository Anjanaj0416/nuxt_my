...
<article>
  ...
  <div class="bg-EF-green-300 p-4 my-1 rounded-lg">
    <div class="grid grid-cols-1 gap-x-2">
      <parameter_select_row :reportparameter="report_details.troponin_1" :arrvalues="initData.arr_Troponin_1"/>  
    </div> 
  </div>
...
export default {
  ...
  methods: {
    getclearValues() {
      ...
      if (this.report_details.troponin_1) {
        this.report_details.troponin_1.value = 'Negative'
      }
