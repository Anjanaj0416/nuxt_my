  ...
  <article>
    ...
    <div class="bg-EF-green-300 p-4 my-1 rounded-lg">
      <div class="grid grid-cols-1 gap-x-2">
        <parameter_text_row :reportparameter="report_details.total_cholesterol" />
      </div>
    </div>
...
export default {
  ...
  methods: {
    getclearValues() {
      if (this.report_details.total_cholesterol)
        this.report_details.total_cholesterol.value = 0.0
