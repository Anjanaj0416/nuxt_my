  ...
  <article>
    ...
    <div class="bg-EF-green-300 p-4 my-1 rounded-lg">
      <div class="grid grid-cols-1 gap-x-2">
        <parameter_text_row :reportparameter="report_details.sgot" />
        <parameter_text_row :reportparameter="report_details.sgpt" />
      </div>
    </div>
...
export default {
  ...
  methods: {
    getclearValues() {
      if (this.report_details.sgot) this.report_details.sgot.value = 0.0
      if (this.report_details.sgpt) this.report_details.sgpt.value = 0.0
