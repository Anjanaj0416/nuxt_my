...
<template>
  <div>
    ...
    <div v-show="!modal">
      <input type="text"
        class="w-full p-2 mt-1 text-sm text-gray-700 border rounded-md focus:ring-blue-500 focus:border-blue-500"
    ...
    <div v-show="modal" class="cssSerach">
      <div>
        <input type="text"
          class="w-full p-2 mt-2 text-sm text-gray-700 border rounded-md focus:ring-blue-500 focus:border-blue-500"
...
/* Scrollbar */
.cssSerachedList::-webkit-scrollbar {
  width: 6px;
}
.cssSerachedList::-webkit-scrollbar-thumb {
  background-color: #212ea8; /* Blue thumb */
  border-radius: 3px;
}
...
.cssItemHover {
  background: #212ea8; /* gradient hover */
  color: white;

}

/* Optional: Search input style */
.cssSerach input {
