...
<template>
  <article>
    <div class="relative">
      ...
      <div class="absolute z-50 w-full p-2 py-2 text-sm text-gray-600 bg-white border-gray-500 rounded" v-show="isopened && search_val!=''">
        ...
        <div
          class="flex py-1 cursor-pointer hover:bg-blue-300"
