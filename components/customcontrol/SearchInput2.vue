...
<template>
  <div>
    ...
    <div v-show="!modal">
      <input type="text"
        class="w-full p-2 mt-1 text-sm text-gray-700 border rounded-md focus:ring-indigo-500 focus:border-indigo-500"
...
.cssSerachedList::-webkit-scrollbar-thumb {
  background-color: #6B21A8; /* Blue thumb */
  border-radius: 3px;
}
...
.cssItemHover {
  background: #6B21A8; /* gradient hover */
  color: white;
