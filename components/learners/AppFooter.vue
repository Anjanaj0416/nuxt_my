      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-2">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <span class="text-xl font-bold">DriveLearn</span>
          </div>
          <p class="text-gray-300 mb-4 max-w-md">
            Connect with trusted driving schools in your area. Compare prices, read reviews, and book lessons online with confidence.
          </p>
