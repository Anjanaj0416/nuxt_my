...
const links = [
  {
    ...
    submenu: [
...

      {
        ...
        icon: "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4zM12 14c-4.42 0-8 2.79-8 6v2h16v-2c0-3.21-3.58-6-8-6z",
        submenu: [
          { name: "Invoice Data Summary Report", to: "/qms/reports?p=R901", },
          { name: "Receipt Data Summary Report ", to: "/qms/reports?ps=R902", },
          { name: "Unsettled Advances", to: "/qms/reports?ps=R903" },
          { name: "Debtor OS report", to: "/qms/reports?ps=R904" },
          { name: "Commission Calculation report", to: "/qms/reports?ps=R905" },
        ],
      },
    ],
  },
