<template>
    <section>
        ...
        <div v-else
            ...
            <!-- MovementDetails -->
            <div v-if="dayInfo?.movementDetails && dayInfo?.movementDetails?.id !== `00000000-0000-0000-0000-000000000000`"
            ...
            <!-- OTDetails -->
            <div v-if="dayInfo?.otDetails && dayInfo?.otDetails?.id !== `00000000-0000-0000-0000-000000000000`"
            ...
            <!-- LeaveDetails -->
            <!-- need to check whether the last record..if it is then add a top border to the every each record
              
             -->
            <div v-if="dayInfo?.leaveDetails && dayInfo?.leaveDetails?.id !== `00000000-0000-0000-0000-000000000000`"
                class="flex flex-col h-full border-b lg:border-b-0 lg:border-r border-gray-400 mr-2 space-y-2">
                <div>
                    <div class="flex-1 space-y-3">
            ...
            <div v-if="dayInfo?.rectificationDetails && dayInfo?.rectificationDetails?.id !== `00000000-0000-0000-0000-000000000000`"
                class="flex flex-col h-full mr-2 space-y-2">
                <div>
                    <div class="flex-1 space-y-3">
