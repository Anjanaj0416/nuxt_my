...
<template>
  <section class="min-h-screen bg-white">
    <div class="px-6 py-6">
        ...
        <div class="flex items-center gap-3">
          <div class="relative">
            <input
              ...
              class="pl-4 pr-10 py-2 rounded-xl border border-black/10 text-sm focus:outline-none focus:ring-2 bg-white"
              style="min-width:220px; focus-ring-color:#C7EA2F;"
            />
      ...
      <!-- ── Orders Table Card ──────────────────────────────── -->
      <div class="mt-6 rounded-3xl border border-black/10 shadow-sm overflow-hidden">
        ...
        <!-- Table Header -->
        <div class="grid px-6 py-3 text-xs font-semibold" style="grid-template-columns:1fr 1.4fr 1fr 1fr 1fr 0.6fr; color:rgba(0,0,0,0.5); background:rgba(0,0,0,0.02);">
          <div>SO No</div>
          <div>Customer</div>
          <div>Order Date</div>
          <div>Status</div>
        ...
        <div
          ...
          :key="order.soNo"
          class="grid px-6 py-4 border-t border-black/10 hover:bg-black/[0.015] transition items-center"
        ...
        >
          ...
          <!-- Net Total -->
          <div class="text-sm font-extrabold text-black text-right">
            {{ formatAmount(order.netTotal) }}
          </div>
        ...
        <!-- Pagination Footer -->
        <div class="flex items-center justify-between px-6 py-4 border-t border-black/10">
          <div class="text-sm" style="color:rgba(0,0,0,0.5);">
            Showing {{ paginationStart }} to {{ paginationEnd }} of {{ filteredOrders.length }}
          </div>
...
export default {
  ...
  methods: {
    ...
    openNewOrder() {
      // TODO: open new order modal or navigate
