<template>
  <section class="justify-center min-h-screen px-4 mt-24 mb-20 lg:px-[60px] md:px-[82px]">
    <div class="text-2xl uppercase">All Banners Details</div>
    <div
    ...
    <assigDtp v-if="isAddLeads" @close="isAddLeads = false" />
...
import assigDtp from "~/components/qms/workFlow/dtp/assigDtp.vue";
