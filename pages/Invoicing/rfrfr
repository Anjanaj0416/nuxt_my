                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-end gap-2">
                                    <button
                                        ...
                                        class="w-auto px-4 py-2 font-semibold text-gray-700 transition duration-300 ease-in-out border-2 border-blue-800 rounded-lg hover:bg-blue-900 hover:text-white focus:ring-2 focus:ring-blue-600 focus:outline-none"
                                        aria-label="View an Invoice"
                                    >
                                        View 
                                    </button>
                                    <button
