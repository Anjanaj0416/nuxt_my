      ...
      <section class="justify-center min-h-screen px-4 lg:px-80">
        ...
        <div class="flex flex-col items-center justify-between mt-10 md:flex-row">
          <div class="w-full md:w-auto">
            <form class="flex items-center justify-center max-w-sm mx-auto" @submit.prevent="handleSearch">
        ...
        <div class="flex flex-wrap gap-4 p-4 mt-10 mb-2 ">
          ...
          <div class="w-auto h-auto bg-gray-100 rounded-lg shadow-md sm:w-1/3">
            <div class="grid grid-cols-2 p-5 text-center gap-y-4">
              <div>
                <h1 class="text-lg font-semibold text-gray-700">Book No</h1>
                <span class="text-sm text-gray-500">15</span>
              </div>
              <div>
                <h1 class="text-lg font-semibold text-gray-700">User</h1>
                <img
            ...
            <div class="flex items-center justify-center p-4 bg-gray-200 rounded-b-lg">
              <h1 class="text-lg font-semibold text-gray-700">072 7052035</h1>
            </div>
          </div>
        </div>
        ...
        <div class="grid gap-4 p-4 mt-0 mb-0">
            ...
            <h2 class="mt-10 text-lg font-semibold text-gray-700">Department Details</h2>
            <hr>
            ...
            <div class="grid flex-1 grid-cols-3 mt-3 gap-y-2">
                <div v-for="(item, index) in filteredDepartmentDataData" :key="'departmentData-' + index">
                    <div class="w-full max-w-sm px-4 pt-1 pb-2 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="grid gap-4 p-4 mt-0 mb-4">
            <!-- Personal Information Header -->
            <h2 class="mt-10 text-lg font-semibold text-gray-700">Membership contact fee</h2>
            <hr>
            <div class="flex flex-col items-center justify-between mt-10 md:flex-row">
            ...
            <!-- Display Bank Information -->
            <div class="grid flex-1 grid-cols-3 mt-3 gap-y-4 ">
                <div>
                    <div class="w-full max-w-sm px-4 pt-4 pb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex flex-col items-center pb-10">
                            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">2025</h5>
                            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">January</h5>
                            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">20</h5>
                        </div>
                    </div>
                </div>
            </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        departmentData: [
          { label: 'Nimal', phone: '074 845267', NIC: '9874525477', Reg: '25/01/025'  },
          { label: 'Rusiru', phone: '074 845267', NIC: '9874525477', Reg: '25/01/025'  },
          { label: 'Kaml', phone: '074 845267', NIC: '9874525477', Reg: '25/01/025'  },
