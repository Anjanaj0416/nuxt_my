<template>
  ...
  <section class="bg-center bg-cover">
    <nav :class="[`fixed top-0 left-0 z-50 w-full bg-${store.pageData.standard.navbar.navbarColor}`, 'bg-blue-100']">
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        <a href="/template/standard/standard" class="flex items-center space-x-3">
          <span class="self-center text-2xl font-semibold text-white">{{ store.pageData.standard.logo || 'Logo'
            }}</span>
        </a>
    ...
    <section>
      <div class="w-full mx-auto mt-16 lg:gap-8 xl:gap-0 lg:mt-16">
        <!-- Responsive Image -->
        <img :src="store.pageData.standard.navbar.navImg1" class="object-cover w-full h-auto" alt="mockup" />
      </div>
    </section>
  </section>
  ...
  <section id="product" class="px-4 py-12 bg-gradient-to-b from-gray-50 to-white">
    ...
    <div class="grid grid-cols-1 gap-8 mx-auto sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 max-w-7xl">
      ...
      <div class="p-4 text-center transition duration-300 bg-white shadow-md rounded-2xl hover:shadow-xl"
        v-for="(product, index) in store.pageData.standard.product.products" :key="index">
  ...
  <section id="about" class="py-12 ">
    <div class="container px-6 mx-auto">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        <div
          class="flex flex-col items-center p-6 text-center transition-transform transform bg-white shadow-md rounded-xl hover:scale-105 hover:shadow-xl">
  ...
  <section id="contact" class="py-8 antialiased md:py-16">
    <div
      ...
      <a href="#" class="flex items-center justify-center p-4 transition-transform duration-500 ease-in-out transform "
        v-for="(product, index) in store.pageData.standard.brand" :key="index" data-aos="fade-up"
        :data-aos-delay="index * 100">
        <img :src="product.image" class="object-contain w-20 h-20" alt="brand logo" />
      </a>
    </div>
  </section>
