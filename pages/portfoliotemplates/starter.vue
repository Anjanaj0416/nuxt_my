<template>
      ...
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        ...
        <button @click="toggleMenu"
          ...
          <svg class="w-5 h-5 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
            <path stroke="purple" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <section id="product" :class="`py-8 antialiased bg-gray-100 md:py-12`">
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
      ...
      <div class="items-end justify-between mb-4 space-y-4 sm:flex sm:space-y-0 md:mb-8">
        <div>
          <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">
            {{ store.pageData.css.product.section2Title }}</h2>
        </div>
      ...
      <div class="grid gap-4 mb-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div :class="`w-full h-56 bg-${store.pageData.css.product.productDetails.productBgColor}`">
            <a href="#" class="">
              <img class="h-full mx-auto dark:hidden"
                :src="store.pageData.css.product.productDetails.product1.productImg1" alt="" />
          ...
          <div class="p-6 pt-6">
            <div class="flex items-center justify-between gap-4 mb-4">
              <span
                class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">{{ store.pageData.css.product.productDetails.product1.discount }}</span>
            ...
            <a href="#"
              class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ store.pageData.css.product.productDetails.product1.name }}</a>
            ...
            <div class="flex items-center justify-between gap-4 mt-4">
              <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">
                Rs.{{ store.pageData.css.product.productDetails.product1.price }}</p>
            </div>
            <div class="flex items-center justify-between gap-4 mt-4">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div :class="`w-full h-56 bg-${store.pageData.css.product.productDetails.productBgColor}`">
            <a href="#" class="">
              <img class="h-full mx-auto dark:hidden"
                :src="store.pageData.css.product.productDetails.product2.productImg2" alt="" />
              <img class="hidden h-full mx-auto dark:block"
                :src="store.pageData.css.product.productDetails.product2.productImg2" alt="" />
            </a>
          </div>
          ...
          <div class="p-6 pt-6">
            <div class="flex items-center justify-between gap-4 mb-4">
              <span
                class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">{{ store.pageData.css.product.productDetails.product2.discount }}</span>
            ...
            <a href="#"
              class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ store.pageData.css.product.productDetails.product2.name }}</a>
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div :class="`w-full h-56 bg-${store.pageData.css.product.productDetails.productBgColor}`">
            <a href="#" class="">
              <img class="h-full mx-auto dark:hidden"
                :src="store.pageData.css.product.productDetails.product3.productImg3" alt="" />
              <img class="hidden h-full mx-auto dark:block"
                :src="store.pageData.css.product.productDetails.product3.productImg3" alt="" />
            </a>
          </div>
          ...
          <div class="p-6 pt-6">
            ...
            <a href="#"
              class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ store.pageData.css.product.productDetails.product3.name }}</a>
            ...
            <div class="flex items-center justify-between gap-4 mt-4">
              <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">
                Rs.{{ store.pageData.css.product.productDetails.product3.price }}</p>
            </div>
            <div class="flex items-center justify-between gap-4 mt-4">
              <button type="button" :class="[
                'inline-flex items-center justify-center rounded-lg border-2 px-5 py-2.5 text-sm font-medium text-black focus:outline-none focus:ring-4',
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div :class="`w-full h-56 bg-${store.pageData.css.product.productDetails.productBgColor}`">
            <a href="#" class="">
              <img class="h-full mx-auto dark:hidden"
                :src="store.pageData.css.product.productDetails.product4.productImg4" alt="" />
              <img class="hidden h-full mx-auto dark:block"
                :src="store.pageData.css.product.productDetails.product4.productImg4" alt="" />
            </a>
          </div>
          ...
          <div class="p-6 pt-6">
            ...
            <a href="#"
              class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{ store.pageData.css.product.productDetails.product4.name }}</a>
            ...
            <div class="flex items-center justify-between gap-4 mt-4">
              <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">
                Rs.{{ store.pageData.css.product.productDetails.product4.price }}</p>
            </div>
            <div class="flex items-center justify-between gap-4 mt-4">
              <button type="button" :class="[
                'inline-flex items-center justify-center rounded-lg border-2 px-5 py-2.5 text-sm font-medium text-black focus:outline-none focus:ring-4',
      ...
      <div class="w-full text-center">
        <button type="button"
          :class="[`rounded-lg border border-${store.pageData.css.btnColor}  px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700`, 'border-gray-600']">Show
          more</button>
      </div>
    </div>
  </section>
  ...
  <section id="about" class="py-12 ">
    <div class="container px-6 mx-auto">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
        <div
          class="flex flex-col items-center p-6 text-center transition-transform transform bg-white shadow-md rounded-xl hover:scale-105 hover:shadow-2xl">
        ...
        <div
          class="flex flex-col items-center p-6 text-center transition-transform transform bg-white shadow-md rounded-xl hover:scale-105 hover:shadow-2xl">
          <div class="p-4 bg-gray-100 rounded-full shadow-md">
            <img class="w-14 h-14" src="/assets/img/digitalTechLabs/contact/QualityProducts.png"
        ...
        <div
          ...
          <h3 class="mt-4 text-lg font-semibold text-gray-800">Best Ratings</h3>
          <p class="mt-2 text-sm text-gray-600">Join thousands of satisfied customers who have given us their stamp of
            approval!</p>
        </div>
      </div>
    </div>
  ...
  <section id="contact" class="bg-gray-100">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
      ...
      <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
        <img :src="store.pageData.css.aboutParagraph.aboutImg" class="relative w-full h-[25vh] object-cover"
  ...
  <section class="relative flex items-center py-12 text-white bg-center bg-no-repeat bg-cover"
    style="background-image: url('https://img.freepik.com/premium-photo/fashionable-adult-customer-exploring-boutique-studio-with-modern-wardrobe-display_634278-45040.jpg?w=996');">
    ...
    <div class="max-w-screen-xl mx-auto">
      <div class="md:flex md:justify-between">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Our Resources</h2>
            <ul class="text-gray-600 dark:text-gray-400">
              <li class="mb-4">
                <a href="https://your-clothing-store.com" class="hover:underline">Our Clothing Collection</a>
              </li>
              <li class="mb-4">
                <a href="https://your-clothing-store.com/blog" class="hover:underline">Fashion Blog</a>
              </li>
              <li class="mb-4">
                <a href="https://your-clothing-store.com/size-guide" class="hover:underline">Size Guide</a>
              </li>
              <li>
                <a href="https://your-clothing-store.com/contact" class="hover:underline">Contact Us</a>
              </li>
            </ul>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href=""
            class="hover:underline">DigitalTechLab™</a>. All Rights Reserved.
        </span>
