    ...
    <section class="fixed top-0 left-0 z-50 w-full bg-center bg-cover">
        ...
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-2 mx-auto">
            ...
            <ul class="flex space-x-8 font-medium">
                <li><a href="/template/enterprise/giftvouchers" class="text-sm font-semibold text-white hover:text-gray-300">Gift Vouchers</a></li>
                <li><a href="/template/enterprise/sale" class="text-sm font-semibold text-white hover:text-gray-300">Sale</a></li>
                <li><a href="/template/enterprise/gallery" class="text-sm font-semibold text-white hover:text-gray-300">Gallery </a></li>
                <li><a href="/template/enterprise/aboutUs" class="text-sm font-semibold text-white hover:text-gray-300">About</a></li>
