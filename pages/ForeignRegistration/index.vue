  ...
  <section class="flex items-center justify-center min-h-screen px-4 bg-gray-100">
    <div
      ...
      <div class="w-full p-10 bg-white">
        ...
        {{ vendorStore.initVendor.listDistrictCities }}
        <div class="grid grid-cols-1 gap-4 mt-12 mb-4 sm:grid-cols-2 md:grid-cols-2">
          <div>
          ...
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-500">District</label>
            <div class="relative w-full">
              <serachInput
                :arrItems="vendorStore.initVendor.listDistrictCities"
              />
          ...
          <div>
            ...
            <div class="relative">
              <input type="text" v-model="curLead.email" placeholder="Enter Email" required
                class="w-full px-4 py-2 pr-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-300" />
              <p v-if="err.Address" class="mt-2 text-sm text-red-600">
                {{ err.Address }}
              </p>
        ...
        <div class="grid grid-cols-1 gap-4  mb-4 sm:grid-cols-2 md:grid-cols-2">
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-500">Contact Person Name</label>
            <div class="relative">
              <input type="text" v-model="curLead.email" placeholder="Enter Name" required
                class="w-full px-4 py-2 pr-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-300" />
              <p v-if="err.Address" class="mt-2 text-sm text-red-600">
                {{ err.Address }}
              </p>
          ...
          <div>
            <label class="block mb-1 text-sm font-medium text-gray-500">Contact Person Designation </label>
            <div class="relative">
              <input type="text" v-model="curLead.email" placeholder="Enter Designation " required
                class="w-full px-4 py-2 pr-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-300" />
              <p v-if="err.Address" class="mt-2 text-sm text-red-600">
                {{ err.Address }}
              </p>
