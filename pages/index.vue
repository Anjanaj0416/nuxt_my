...
<article>
    ...
    <div class="grid gap-12 md:grid-cols-2">
      ...
      <div class="max-w-xl">
        ...
        <p class="mt-4 text-lg text-gray-700">
          Digital TechLabs delivers innovative digital solutions, including web and mobile apps, 
          cloud services, and AI analytics, to help businesses thrive in a fast-changing digital world. 
          We proudly support and enhance B2B.LK, Sri Lanka’s emerging B2B marketplace, connecting vendors and buyers to unlock new growth opportunities. 
          Join us as we transform the way Sri Lankan businesses connect and grow.
        </p>
        <p class="mt-4 text-lg text-gray-700">
  ...
  <section class="px-6 py-2 mx-auto bg-gradient-to-r from-blue-900 to-blue-500 rounded-3xl max-w-7xl">
    <div class="mx-auto text-center lg:py-16 lg:px-2">
      ...
      <button type="button"
        class="px-3 py-2 mt-4 text-sm font-medium text-center text-blue-900 bg-white rounded-full hover:bg-blue-800 hover:shadow-xl ">
        Contact Us →
      </button>
    </div>
  </section>
